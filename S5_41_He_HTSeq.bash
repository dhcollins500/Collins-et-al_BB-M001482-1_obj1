...
# Tasks: Count He et al. (2017) reads mapped by HISAT2 to genes using HTSeq-count.
#-------------------------------------------------------------------------------
# Inputs:
...
mkdir ../02_outputs/31_he_htseq_count
...
do
	OUTFILE=${NAME:0:9}
htseq-count -f bam ${NAME} ../../00_data/02_gtf/Apis_mellifera.Amel_4.5.48.gtf.gz > ../31_he_htseq_count/${OUTFILE}_HTSeq.txt
done
