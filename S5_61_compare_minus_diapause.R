...
# expressed genes (DEGs) from the current study and those of Cameron et al.
# (2013) and He et al. (2017), with and without diapause genes from Amsalem et 
# al. (2015) included.
#-------------------------------------------------------------------------------
# Inputs:
...
# subdirectory created by script S5_01.
...
write.csv(combinedResults, "supplementary_Table_S16.csv",
          row.names = FALSE)
