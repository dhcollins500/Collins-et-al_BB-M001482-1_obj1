#DavidHCollins
#01 January 2019
#This script is to add all the figures and statistical (but not bioinformatics) analysis for the planned manuscript: Collins et al. Gene expression in the larval caste differentiation of bumble bees.
...
gene.names = as.character(microarray[,6])
...
# The Cardoen et al 2011 data set uses OGS_v1_1 Ids, therefore remove the other Apis Ids
