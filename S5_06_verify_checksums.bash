...
# Tasks: Verify checksums of downloaded Apis mellifera (Amel) and Bombus 
# terrestris (Bter) genome files.
#-------------------------------------------------------------------------------
# Inputs:
# Amel and Bter fasta and annotation files, and associated checksum files, downloaded
# from Ensembl using script 05.
#
# Outputs:
...
# Amel genome checksums.

awk '/Apis_mellifera.Amel_4.5.dna.toplevel.fa.gz/' Amel_dna_toplevel_checksums.txt > original_ensembl_checksums.txt

# Bter genome checksums.

awk '/Bombus_terrestris.Bter_1.0.dna.toplevel.fa.gz/' Bter_dna_toplevel_checksums.txt > original_ensembl_checksums.txt

# Amel GTF checksums.

awk '/Apis_mellifera.Amel_4.5.48.gtf.gz/' Amel_gtf_checksums.txt >> original_ensembl_checksums.txt
...
echo "$(sum ../01_fasta/Apis_mellifera.Amel_4.5.dna.toplevel.fa.gz) $(echo Apis_mellifera.Amel_4.5.dna.toplevel.fa.gz)" > downloaded_ensembl_checksums.txt
...
echo "$(sum ../02_gtf/Apis_mellifera.Amel_4.5.48.gtf.gz) $(echo Apis_mellifera.Amel_4.5.48.gtf.gz)" >> downloaded_ensembl_checksums.txt
...
mkdir ../../02_outputs/00_checksums

# Make empty file for results output

touch ../../02_outputs/00_checksums/checksums_ensembl_comparison_results.txt
...
echo -e $RESULTS >> ../../02_outputs/00_checksums/checksums_ensembl_comparison_results.txt
